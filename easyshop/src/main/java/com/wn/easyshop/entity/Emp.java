package com.wn.easyshop.entity;
...
public class Emp {
	...
	public String toString() {
		return "User [euUserId=" + euUserId + ", euUserName=" + euUserName + ", euPassword=" + euPassword + ", euSex="
				+ euSex + ", euBirthday=" + euBirthday + ", euIdentityCode=" + euIdentityCode + ", euEmail=" + euEmail
				+ ", euMobile=" + euMobile + ", euAddress=" + euAddress + ", euStatus=" + euStatus + "]";
	}
}
