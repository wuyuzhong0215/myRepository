package com.wn.phoneinfo.controller;
...
import com.wn.phoneinfo.service.InformationsService;
import com.wn.phoneinfo.service.RepliesService;
...
public class Controller {
    ...
    public String toIndex(HttpServletRequest request){
        ...
        List<Informations> informations = informationsService.getInformations();
    ...
    public String toMain(HttpServletRequest request, final String infoid) {
        ...
        List<Informations> informations = (List<Informations>) request.getSession().getAttribute("informations");
        Iterator<Informations> iterator = informations.iterator();
        while (iterator.hasNext()){
            Informations info = iterator.next();
            if (info.getId()==id){
